...
//            try
//            {
//                CodingQuestionResult? assessments = await _applicationDbContext.CodingAssessmentResult.FirstOrDefaultAsync(_ => _.CodingAssessmentResultId== codingAssessmentId);
//                if (assessments == null)
//                {
...
//            try
//            {
//                List<CodingQuestionResult> assessments = await _applicationDbContext.CodingAssessmentResult.ToListAsync();
//                return new ResponseDto(assessments, true, "");
...
//            try
//            {
//                List<CodingQuestionResult> assessments = await _applicationDbContext.CodingAssessmentResult.Where(_ => _.AssessmentId == nexusId).ToListAsync();
//                return new ResponseDto(assessments, true, "");
