...
//        public async Task<ResponseDto> Create(HttpContext httpContext, Classroom nexus)
//        {
//            if (nexus == null)
//            {
...
//            try
//            {
//                var nexus = await _applicationDbContext.Nexus.FirstOrDefaultAsync(n => n.ClassroomId == ClassroomId);
//                if (nexus == null)
//                {
...
//        public async Task<ResponseDto> Edit(HttpContext httpContext, Classroom nexus)
//        {
//            if (nexus == null)
//            {
//                throw new ArgumentNullException(nameof(nexus));
...
//            try
//            {
//                var existingNexus = await _applicationDbContext.Nexus.FirstOrDefaultAsync(n => n.ClassroomId == nexus.ClassroomId);
...
//                var nexuses = await _applicationDbContext.Nexus.Where(n => n..ToString() == userId).ToListAsync();
//                if (nexuses == null || nexuses.Count == 0)
//                {
...
//                var nexus = await _applicationDbContext.Nexus.FirstOrDefaultAsync(n => n.ClassroomId.ToString() == nexusCode);
//                if (nexus == null)
//                {
